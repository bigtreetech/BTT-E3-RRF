...
M584 X0 Y1 Z2 U4 E3:5                          ; set drive mapping
M350 X16 Y16 U16 Z16 E16 I1                    ; configure microstepping with interpolation
M92 X80.00 Y80.00 Z400.00 E93.00:137.3            ; set steps per mm
...
M906 X800 Y800 U800 Z800 E800 I30                   ; set motor currents (mA) and motor idle factor in per cent
M84 S30                                        ; Set idle timeout

; Axis Limits
M208 X-55 Y0 U0 Z0 S1                           ; set axis minima
M208 X108 Y235 U171 Z250 S0                    ; set axis maxima

; Endstops
M574 X1 S1 P"!xstop"                            ; configure active-high endstop for low end on X via pin xstop
M574 U2 S1 P"!x2stop"                           ; configure active-high endstop for low end on X via pin xstop
...
M307 H0 R2 D120 B1 S1.00                        ; disable bang-bang mode for the bed heater and set PWM limit
...
; EXP-Fans
M950 F2 C"fan3" Q1000                          ; create fan 2 on pin fan0 and set its frequency
M106 P2 S0 H-1                                 ; set fan 0 value. Thermostatic control is turned off
M950 F3 C"fan2" Q1000                          ; create fan 3 on pin fan1 and set its frequency
M106 P3 S255 H2 T45  
...
M563 P1 D1 H2 X3 F2:3                           ; define tool 0
G10 P1 Y-2 U0 Z0.3 S0 R0

M563 P2 D0:1 H1:2 X0:3 F0:1:2:3:4 S"COPY" 
G10 P2 X55 Y0 U-55 S0 R0  
M567 P2 E1:1
M563 P3 D0:1 H1:2 X0:3 F0:1:2:3:4 S"MIRROR" 
